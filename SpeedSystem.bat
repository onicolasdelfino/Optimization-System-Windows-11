...
ECHO * 5. Desativar Serviços Inúteis  *
ECHO * 6. Configuração para Alto Desempenho no Gerenciador de Energia *
ECHO * 7. Otimização de Inicialização *
ECHO * 8. Voltar                     *
ECHO ===============================
...
IF %limp% EQU 6 GOTO limp6
IF %limp% EQU 7 GOTO limp7
IF %limp% EQU 8 GOTO menu

IF %limp% GTR 8 GOTO invalid_choice
...
:limp5
CLS
TITLE DESATIVANDO SERVIÇOS INÚTEIS...
ECHO ==================================
ECHO * Desativando serviços desnecessários *
ECHO ==================================
:: Aqui você pode adicionar os comandos para desativar serviços específicos
:: Exemplo: SC stop nome_do_serviço
...
:limp6
CLS
TITLE CONFIGURANDO ALTO DESEMPENHO...
ECHO ==================================
ECHO * Configurando para alto desempenho... *
ECHO ==================================
...
:limp7
CLS
TITLE OTIMIZANDO INICIALIZAÇÃO...
ECHO ==================================
ECHO * Otimizando a inicialização do sistema... *
ECHO ==================================
:: Aqui você pode adicionar os comandos para otimizar a inicialização
ECHO Inicialização otimizada com sucesso!
PAUSE > nul
GOTO menu
